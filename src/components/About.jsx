...
const About = () => {
  return (
    <div className=' md:mt-16'>
      ...
      <section className='section md:px-10'>
          <div className=' mb-10 lg:flex lg:justify-center max-w-[1200px] lg:mx-auto lg:items-center'>
            <div className=' lg:w-[60%]'>
              <div>
                <img src={about} className=' drop-shadow-lg' alt="" />
              </div>
            </div>
            <div className=' lg:w-[40%]'>
              <div className=' text-[#e87817] font-semibold mb-7'>- About Absy IT Solutions -</div>
              <div className=' text-xl font-bold mb-5'>We are Focused on <span className=' block'>Exceptional Service and Innovation</span></div>
              <div className='mb-7'>Absy Solutions is a team of forward-thinking professionals dedicated to delivering cutting-edge software 
              ...
              <div className=' flex flex-col gap-4 mb-7'>
                <div className=' flex items-center gap-3'>
                  ...
                  <div className=' font-semibold'>Expert Technical Architects</div>
                </div>
                <div className=' flex items-center gap-3'>
                  <div className=' text-[#e87817]'><TiTick/></div>
      ...
      <section className='section md:px-10'>
        <div>
            <div className=' text-xl font-bold mb-5 md:text-center text-center'>Meet Our Team</div>
            <div className='mb-7 md:text-center md:px-10 lg:px-20 2lg:px-40 text-center'>our team is made up of passionate and experienced professionals committed to excellence. 
            We bring together a blend of skills and expertise to ensure top-quality solutions and exceptional results for our clients.</div>
            {/* Team Members */}
            <div className=' grid grid-cols-1 place-items-center gap-10 md:grid-cols-2 max-w-[1200px] 2lg:grid-cols-3 lg:mx-auto'>
              <div className=' w-full h-[400px] rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
